...
public final class AntiXrayHeuristics extends JavaPlugin implements Listener {
    ...
    private final int suspicionStreakZeroThreshold = 20; //Amount of consecutive times after which a player is considered as no longer mining.
    ...
    private int usualEncounterThreshold; //Threshold of mined non-ore blocks after which we consider the player is definitely mining legit
